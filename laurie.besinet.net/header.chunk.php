...
<html lang="en">
	<head>
		...
		<!-- Styles -->
		<link rel="stylesheet" href="<?php echo Site::url(); ?>/public/themes/flatly/css/bootstrap-flatly.min.css" type="text/css" />
		<?php Stylesheet::add('public/themes/flatly/css/default.css', 'frontend', 2); ?>
		<link rel="stylesheet" href="<?php echo Site::url(); ?>/public/themes/flatly/plugs/owl/assets/owl.carousel.css" type="text/css" />
		<link rel="stylesheet" href="<?php echo Site::url(); ?>/public/themes/flatly/plugs/owl/assets/owl.theme.default.min.css">
		<?php Stylesheet::load(); ?>
		...
		<?php Javascript::add('public/themes/flatly/plugs/owl/owl.carousel.min.js', 'frontend', 3); ?>
		<?php Javascript::load(); ?>
	...
	<body>
		...
		<div class="navbar navbar-default">
			<div class="container">
				<div class="navbar-header">
					<a href="<?php echo Site::url(); ?>" class="navbar-brand"><?php echo Site::name(); ?></a>
		...
		<div class="page-header container">
			...
			<?php } elseif (Uri::segment(0) == 'home') { ?>

			<div class="owl-carousel">
				<div><img src="<?php echo Site::url(); ?>/public/themes/flatly/images/slide1.jpg" alt="slide1"></div>
				<div><img src="<?php echo Site::url(); ?>/public/themes/flatly/images/slide2.jpg" alt="slide2"></div>
				<div><img src="<?php echo Site::url(); ?>/public/themes/flatly/images/slide3.jpg" alt="slide3"></div>
				<div><img src="<?php echo Site::url(); ?>/public/themes/flatly/images/slide4.jpg" alt="slide4"></div>
			</div>

			<?php } elseif (Uri::segment(0) == '') { ?>

      ...
      <div>
          ...
          <div>
            <div class="title-page">
              <h2 class="i18n_a3_title title-description" style="text-transform: uppercase;"></h2>
              <span class="i18n_a3_param text-muted font-italic"></span>
            </div>
            <div class="i18n_a3_intro"></div>
            <br><br>
            <div class="i18n_a3_content"></div>
          </div>
          <!--End article-->

...
<head>
  ...
  <meta property="og:url" content="https://laurie.besinet.net/2018-smag.php">
      ...
      <div>
          ...
          <!-- article --> <!---- NO ARTICLE ---->
            <div class="title-page">
              <h2 class="i18n_job_smag_entr title-description" style="text-transform: uppercase;">Domaine de aneouthe</h2>
            </div>

              <!-- Start aneouthe job 1 -->
            <div class="i18n_job_smag_date text-muted font-italic">Juin - Sept 2011</div>
            <h4 class="spec i18n_job_smag_title">Stage en Ferme</h4>
            <div class="i18n_job_smag_desc">1 employé | Lot-et-Garonne (47), FRANCE <br> Ferme de 80 ha et 250 moutons allaitants.</div>
            <br><br>
            <div class="i18n_job_smag_text">J'ai travaillé dans un élevage de moutons pendant l'été. La famille m'a accueillie pendant les 3 mois et je me suis intégrée à leur quotidien.</div>
              ...
              <!-- <div>
                <div class="accordion-group">
                  <div class="accordion-heading togglize">
                    <a class="accordion-toggle i18n_job_smag_mission" data-toggle="collapse" data-parent="#" href="#collapseTen">Travail dans l'élevage<span class="font-icon-plus"></span><span class="font-icon-minus"></span></a>
                  </div>
                  <div id="collapseTen" class="accordion-body collapse">
                    <div class="accordion-inner">
                      <span class="i18n_job_smag_proj">J'ai participé aux travaux de la ferme : <br> - conduire le troupeau dans les champs avec le chien <br> - nourrir les agneaux <br> - vendre la viande au marché <br> - aider lors de la tonte des moutons <br> - récolter les céréales et le fourrage.</span>
                    </div>
                  </div>
                </div>
        ...
        <div class="share-links">
          <ul>
            ...
            <li><!-- Facebook --> <!---- NO ARTICLE ---->
              <a title="Share with Facebook" href="http://www.facebook.com/sharer.php?u=https://laurie.besinet.net/2018-smag.php" target="_blank">
                <span class="font-icon-social-facebook"></span>
              </a>
            </li>
            <li><!--------------------------------- PB LinkedIn --> <!---- NO ARTICLE ---->
              <a title="Share with LinkedIn" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=https://laurie.besinet.net/2018-smag.php" target="_blank">
                <span class="font-icon-social-linkedin"></span>
              </a>
            </li>
            <li><!----------------------------------- Twitter  --> <!---- NO ARTICLE ---->
              <a title="Share with twitter" href="https://twitter.com/share?url=https%3A%2F%2Flaurie.besinet.net%2F2018-smag.php&amp;via=lauriebesinet" target="_blank">
            ...
            <li><!-- Email --> <!---- NO ARTICLE ---->
              <a title="Send by email" href="mailto:?Subject=&amp;Body=https://laurie.besinet.net/2018-smag.php">

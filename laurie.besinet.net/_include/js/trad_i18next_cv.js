    ...
    resources: {
      en: {
        translation: {
          ...
          "key_job_pio_proj3": " - With documentary researches and field survey, I determined the optimal conditions for the disease <br> - I coded a computerized DST (in VBA) that considers the environmental and agronomic parameters <br> - I conducted field tests in farms, which have been successful <br>Today the DST is operational and is used by field agents and farmers.",
      ...
      fr: {
        translation: {
          ...
          "key_job_wnt_date1": "Jan 2016 - Nov 2017",
          "key_job_wnt_title1": "Responsable de Projets",
          "key_job_wnt_text1": "Dans cette jeune TPE j'avais beaucoup de responsabilités. Mes quatres missions principales :",
          "key_job_wnt_mission1": "Créer, développer et améliorer les modèles agronomiques et les Outils d'Aide à la Décision (OAD)<span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          ...
          "key_job_wnt_mission2": "Recherche et développement de nouveaux partenariats stratégiques <span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_wnt_proj2": "J'ai participé à divers congrès et colloques pour y rencontrer des potentiels partenaires du monde agricole, intéressés pour travailler avec Weenat sur des projets d'innovation. Deux exemples de projets d'innovation que j'ai contribué à monter : <br> - La détetion et le pilotage de l'azote dans les culture, grâce à de nouveaux capteurs et modèles <br>&nbsp;&nbsp;&nbsp;o Le projet sélectionné a été monté avec l'INRA et les Chambres d'Agriculture  <br>&nbsp;&nbsp;&nbsp;o Le projet a été sélectionné dans le cadre du programme “Initiatives Innovantes en agriculture et agroalimentaire” du ministère de l'agriculture. <br> -  Développement d'un OAD pour appliquer un produit de biocontrôle dans les conditions optimales <br>&nbsp;&nbsp;&nbsp;o Les partenaires de Weenat sont des cooperatives, des instituts de recherche et un industriel agro-chemiste <br>&nbsp;&nbsp;&nbsp;o Le projet a été sélectionné dans le cadre des “Fonds Uniques Interministériels” pilotés par les ministères de l'économie, de l'Industrie et de l'emploi.",
          "key_job_wnt_mission3": "Responsable des comptes clés<span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_wnt_proj3": "J'étais responsable des comptes clés : <br> - Edition des devis, suivi des commandes et des expéditions <br> - Présence sur place lors des installations <br> - Suivi des client avant, pendant et après la saison <br> - Analyse des retours et transfer au service concerné (informatique, electronique, ...) <br> - Réflexion sur les moyens de répondre au mieux aux attentes des clients",
          "key_job_wnt_proj4": "J'ai aussi travaillé sur des sujets de communication et marketing : <br> - Suivi des actualités en agriculture, technologies, concurrences, etc. <br> - Partage de nouvelles à propos de l'entreprise et des innovation du secteur agri-tech sur les réseaux sociaux (twitter, facebook, site web) <br> - Participation aux salons et évènements (Salon Internation de l'Agriculture, Salon International du Machinisme Agricole, ... <br> - Rédaction des documents de communications en tant que responsable produit",
          "key_job_wnt_mission4": "Communication et marketing<span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",

          "key_job_pio_entr": "Dupont Pioneer",
          "key_job_pio_desc": "<a target=\"_blank\" href=\"https://www.pioneer.com\">www.pioneer.com</a> | Plus de 10,000 employés dans le monde | Aussonne (31), FRANCE <br> Dupont Pioneer est un semencier international spécialisé dans le maïs, tournesol, colza et soja.",
          "key_job_pio_date1": "Mai - Dec 2015",
          "key_job_pio_title1": "Assistante Communication et Marketing",
          "key_job_pio_text1": "Quotidiennement j'écrivais les argumentaires techniques pour les supports de communication, au coeur de l'équipe commerciale. Deux autres missions:",
          "key_job_pio_mission1": "Livret de résultats techniques <span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_pio_proj1": "Le livret de résultats est le document phare de l'année. Dans un premier temps, j'ai rassemblé les données techniques et les témoignages d'agriculteurs, puis les ai organisés et verbalisés. Ensuite j'ai organisé l'impression en plusieur centaines de copies et les ai fait envoyer aux agriculteurs français.",
          "key_job_pio_mission2": "Video de Promotion <span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_pio_proj2": "Une video présentant un nouveau type de sac de semences. J'ai designé promotional video about a new opening of seed bags that I put forward, designed, shot and edited has been viewed more than 2,000 times on YouTube.",
          "key_job_pio_date2": "May - Dec 2014",
          "key_job_pio_title2": "Stagiaire Agronome",
          "key_job_pio_text2": "Mon objectif était de fournir un support technique aux agents terrain sur le mildiou du maïs:",
          "key_job_pio_mission3": "Conception d'un Outil d'Aide à la Décision sur le Mildiou du Maïs <span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_pio_proj3": " - Avec des recherches documentaires et une enquête terrain, j'ai déterminé les conditions optimales de développement de la maladie <br> - J'ai codé un OAD informatisé (en language VBA)qui prend en considération les paramètres environnementaux et agronomiques <br> - J'ai mis en place des essais dans des exploitations qui ont été réussis. <br> AUjourd'hui l'OAD est opérationnele et utilisé par les agents de terrain et les agriculteurs.",

          "key_job_ns_entr": "Nutrition et Sante",
          "key_job_ns_desc": "<a target=\"_blank\" href=\"https://www.nutritionetsante.com\">www.nutritionetsante.com</a> | 1750 employés en France | Revel (31), FRANCE <br> Fabricant de produits diététiques, bio et vététaux, dont les marques sont connues dans le monde entier (Gerblé, Isostar).",
          "key_job_ns_date1": "Mai - Jul 2013",
          "key_job_ns_title1": "Stagiare Qualité",
          "key_job_ns_text1": "J'ai travaillé avec les 7 personnes de l'équipe dan sle laboratoire de qualité physico-chimique. Les différents tests conduits concernaient l'apparence, la texture, la conservation et la composition nutritionnelle des produits. Ma mission principale :",
          "key_job_ns_mission1": "Sélection de matériel d'analyse chimique et paramétrage<span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_ns_proj1": "J'ai sélectionné un nouvel équipement pour l'analyse des acides gras des biscuits. Une fois que le Chromatographe liquide haute pression a été livré, j'ai réglé les différents paramètres. <br> C'est aujourd'hui utilisé quotidiennement pour le contrôle des biscuits.",

          "key_job_ane_entr": "Laboratoire Ané",
          "key_job_ane_desc": "<a target=\"_blank\" href=\"https://www.wisc.edu\">www.wisc.edu</a> | Université du Wisconsin | Madison, Wisconsin, USA <br> Laboratoire de recherche fondamentale sur les interactions entre les microorganismes et les plantes.",
          "key_job_ane_date1": "Juil - Sept 2012",
          "key_job_ane_title1": "Stagiaire en Laboratoire de Recherche",
          "key_job_ane_text1": "Ma première longue expérience dans un pays étranger, loin de chez moi. J'ai particulièrement apprécié rencontrer de nouvelles personnes, discuter de leur mode de vie, leur culture. <br> Au laboratoire, j'ai étudié les symbioses plantes-champignons au niveau de l'ADN en assistant les chercheurs et en mettant en place des protocoles d'expérimentation:",
          "key_job_ane_mission1": "Gestion d'expérimentations sur les interactions plantes-champignons<span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_ane_proj1": "J'ai contribué à : <br> - démontrer l'implication d'une protéine étudiée dans la symbiose entre les fabacées et les Rhyzobium <br> - gérer les essais depuis les semis jusqu'à l'analyse des résultats. <br> Les résultats ont été utilisés dans une publication scientifique.",

          "key_job_lam_entr": "Domaine de Lamouthe",
          "key_job_lam_desc": "1 employé | Lot-et-Garonne (47), FRANCE <br> ferme de 80 ha et 250 moutons allaitants.",
          "key_job_lam_date1": "Juin - Sept 2011",
          "key_job_lam_title1": "Stagiaire en Ferme",
          "key_job_lam_text1": "J'ai travaillé dans un élevage de moutons pendnat l'été. La famille m'a accueillie pendant les 3 mois et je me suis intégrée à leur quotidien.",
          "key_job_lam_mission1": "Travail dans l'élevage<span class=\"font-icon-plus\"></span><span class=\"font-icon-minus\"></span>",
          "key_job_lam_proj1": "J'ai participé aux travaux de la ferme : <br> - conduire le troupeau dans les champs avec le chien <br> - nourrir les agneaux <br> - vendre la viande au marché <br> - aider lors de la tonte des moutons <br> - récolter les céréales et le fourrage.",

          "key_job_ref": "Références disponibles sur demande",

          "key_etu": "Etudes",

          "key_etu_pur_eco": "Ecole d'Ingénieurs de PURPAN",
          "key_etu_pur_desc": "<a target=\"_blank\" href=\"https://www.purpan.fr\">www.purpan.fr</a> | Toulouse (31), FRANCE",
          "key_etu_pur_date": "2010 – 2015",
          "key_etu_pur_titre": "Diplôme d'Ingénieur en Agriculture",
          "key_etu_pur_details": "Agriculture en général, sciences de la vie, marketing, gestion de projet. Acquisition des compétences pour gérer la complexité et devenir un agent du changement : <br> - effectuer des analyses contextuelles du monde agricole, <br> - utiliser les outils de l'ingénieur, <br> - diriger une entreprise, <br> - réaliser le changement. <br> Spécialisation de dernière année : Accompagnement, Conseil et Innovation en Agriculture",

          "key_etu_for_eco": "Université fédérale du Ceara",
          "key_etu_for_desc": "<a target=\"_blank\" href=\"https://www.ufc.br\">www.ufc.br</a> | Centre des sciences agraires | Fortaleza, BRESIL",
          "key_etu_for_date": "Aout – Dec 2013",
          "key_etu_for_titre": "Licence en engenierie de l'alimentation",
          ...
          "key_comp_lang_skills2": "Anglais : professionnel",
          "key_comp_lang_skills3": "Portugais : discussion aisée",
  ...
  function updateContent() {
    document.getElementById('i18n_cv_title').innerHTML = i18next.t('key_title');
//    document.getElementById('i18n_cv_welcome').innerHTML = i18next.t('key_welcome');
//    document.getElementById('i18n_cv_hello').innerHTML = i18next.t('key_hello');
    document.getElementById('i18n_hello2').innerHTML = i18next.t('key_hello2');
    document.getElementById('i18n_cv_newzealand').innerHTML = i18next.t('key_newzealand');
//    document.getElementById('i18n_cv_newzealand2').innerHTML = i18next.t('key_newzealand');
    document.getElementById('i18n_cv_resume').innerHTML = i18next.t('key_resume');
    document.getElementById('i18n_cv_resume2').innerHTML = i18next.t('key_resume');
    document.getElementById('i18n_cv_experiences').innerHTML = i18next.t('key_experiences');
...
//    document.getElementById('i18n_cv_contact2').innerHTML = i18next.t('key_contact');
    ...
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_entr').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_entr')[i].innerHTML= i18next.t('key_job_wnt_entr');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_date1').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_date1')[i].innerHTML= i18next.t('key_job_wnt_date1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_text1').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_text1')[i].innerHTML= i18next.t('key_job_wnt_text1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_title1').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_title1')[i].innerHTML= i18next.t('key_job_wnt_title1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_mission2').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_mission2')[i].innerHTML= i18next.t('key_job_wnt_mission2');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_proj2').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_proj2')[i].innerHTML= i18next.t('key_job_wnt_proj2');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_mission3').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_mission3')[i].innerHTML= i18next.t('key_job_wnt_mission3');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_proj3').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_proj3')[i].innerHTML= i18next.t('key_job_wnt_proj3');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_mission4').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_mission4')[i].innerHTML= i18next.t('key_job_wnt_mission4');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_wnt_proj4').length;i++){document.getElementsByClassName('i18n_cv_job_wnt_proj4')[i].innerHTML= i18next.t('key_job_wnt_proj4');}

    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_mission1').length;i++){document.getElementsByClassName('i18n_cv_job_pio_mission1')[i].innerHTML= i18next.t('key_job_pio_mission1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_proj1').length;i++){document.getElementsByClassName('i18n_cv_job_pio_proj1')[i].innerHTML= i18next.t('key_job_pio_proj1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_desc').length;i++){document.getElementsByClassName('i18n_cv_job_pio_desc')[i].innerHTML= i18next.t('key_job_pio_desc');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_entr').length;i++){document.getElementsByClassName('i18n_cv_job_pio_entr')[i].innerHTML= i18next.t('key_job_pio_entr');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_date1').length;i++){document.getElementsByClassName('i18n_cv_job_pio_date1')[i].innerHTML= i18next.t('key_job_pio_date1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_text1').length;i++){document.getElementsByClassName('i18n_cv_job_pio_text1')[i].innerHTML= i18next.t('key_job_pio_text1');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_mission2').length;i++){document.getElementsByClassName('i18n_cv_job_pio_mission2')[i].innerHTML= i18next.t('key_job_pio_mission2');}
    for(i =0; i<  document.getElementsByClassName('i18n_cv_job_pio_proj2').length;i++){document.getElementsByClassName('i18n_cv_job_pio_proj2')[i].innerHTML= i18next.t('key_job_pio_proj2');}
